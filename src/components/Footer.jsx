      ...
      <footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div className="container flex flex-col items-center px-5 py-24 mx-auto md:flex-row">
          <div className="flex flex-col items-center text-center">
            <Link to="/">
              <img className="h-8 w-auto mb-4" src={cz} alt="Your Company" />
            </Link>
            <p className="text-sm text-gray-500">Transforming Your Digital Experience with Innovative Solutions!</p>
          ...
          <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
              <h2 className="mb-3 text-sm font-medium tracking-widest text-gray-900 uppercase title-font">Digital Solutions</h2>
              <nav className="mb-10 list-none">
                <li className="mt-3">
                  <a className="text-gray-500 cursor-pointer hover:text-gray-900">Our Services</a>
                </li>
                <li className="mt-3">
                  <a className="text-gray-500 cursor-pointer hover:text-gray-900">Technology & Innovation</a>
                </li>
              </nav>
            </div>
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
              ...
              <nav className="mb-10 list-none">
                <li className="mt-3">
                  <a className="text-gray-500 cursor-pointer hover:text-gray-900">Company Overview</a>
                </li>
                <li className="mt-3">
        ...
        <div className="bg-gray-300">
          <div className="container px-5 py-4 mx-auto">
            <p className="text-sm text-gray-700 capitalize xl:text-center">© 2024 Ustaad. All rights reserved. Delivering Excellence in Digital Solutions.</p>
          </div>
        </div>
      </footer>
    </div>
